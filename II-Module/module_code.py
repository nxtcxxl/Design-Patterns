...
if __name__ == "__main__":
    ...
    print("\n")
    member1 = Member('Oleksandr', 'Ivanko', 3000000)
    member2 = Member('Ivan', 'Baglaychuk', 20000)
    member3 = Member('Taras', 'Kravchyk', 15000)
    member4 = Member('Igor', 'Repienko', 20050)
    member5 = Member('Dmitro', 'Chornobai', 100000)
